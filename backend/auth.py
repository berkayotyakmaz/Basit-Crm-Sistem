"""
Auth modulu - Kullanici kimlik dogrulama.
Sifreler PBKDF2-HMAC-SHA256 ile hash'lenir.
"""
import hashlib
import hmac
import json
...
class KullaniciAuth:
    """Sistem kullanicisi (auth icin)."""

    def __init__(self, kullanici_adi: str, sifre_hash: str, salt: str,
                 ad: str = "", rol: str = "yonetici", olusturma: str = None):
    ...
    @classmethod
    def from_dict(cls, d: dict) -> "KullaniciAuth":
        return cls(**d)


class AuthYoneticisi:
    """Kullanici CRUD + login islemleri."""

    PBKDF2_ITER = 200_000

    def __init__(self, dosya_yolu: str):
        self.dosya_yolu = dosya_yolu
        self._kullanicilar: dict[str, KullaniciAuth] = {}
        self._yukle()
    ...
    def kullanici_ekle(self, kullanici_adi: str, sifre: str,
                       ad: str = "", rol: str = "yonetici") -> KullaniciAuth:
        ...
        if kullanici_adi in self._kullanicilar:
            raise ValueError(f"Bu kullanici adi zaten kayitli: {kullanici_adi}")
    ...
    def dogrula(self, kullanici_adi: str, sifre: str) -> Optional[KullaniciAuth]:
        kullanici_adi = kullanici_adi.strip().lower()
    ...
    def varsayilan_kullanici_olustur(self) -> KullaniciAuth:
